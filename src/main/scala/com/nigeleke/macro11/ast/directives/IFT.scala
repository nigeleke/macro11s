...
/** If the condition tested upon entering the conditional assembly block is true, the code following this directive, and continuing
  ...
  *   [[IF]]
  */
final case class IFT(comment: Comment) extends Directive

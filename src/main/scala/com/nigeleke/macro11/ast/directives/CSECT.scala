...
/** IAS and RSX-11M assembly-language programs use the [[PSECT]] and [[ASECT]] directives exclusively, because the [[PSECT]]
  * directive provides all the capabilities of the [[CSECT]] directive defined for other PDP-11 assemblers. MACRO-11 will accept
  ...
  *   [[PSECT]]
  */
final case class CSECT(name: String, comment: Comment) extends Directive
